<%@ Page Title="Zamówienia" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderReport.aspx.cs" Inherits="ShopCopyForXML.Storehouse.OrderReport" %>
            ...
            <div id="dData" runat="server">
                <table>
                    ...
                    <tr>
                        ...
                        <td><b>Status całego zamówienia:  </b><asp:DropDownList ID="ddlStatuses" runat="server"></asp:DropDownList></td>                    
                    </tr>
                </table>
                <hr />
                <table>
                    <tr>
                        <td style="width:100%">
                            <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Zapisz status"/>
                        </td>
                        <td>
            ...
            <div id="dProducts" runat="server" visible="false">
                ...
                <div id="dStatus" runat="server">
                    <table>
                        ...
                        <tr>
                            <td style="width:100%">
                                <asp:Button runat="server" ID="btnSaveProductStatus" Text="Zatwierdź" OnClick="btnSaveProductStatus_Click"/>
                            </td>
                            <td>
                                <p  class="validation-summary-errors" >
