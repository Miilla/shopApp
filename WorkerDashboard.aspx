<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WorkerDashboard.aspx.cs" Inherits="ShopCopyForXML.WorkerDashboard" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <aside>
        ...
        <ul>
            ...
            <li><a runat="server" href="~/ShopCopyForXML/Sale.aspx">Sklep</a></li>
